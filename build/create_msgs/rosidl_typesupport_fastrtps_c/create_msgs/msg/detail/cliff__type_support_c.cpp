...
#include "create_msgs/msg/detail/cliff__rosidl_typesupport_fastrtps_c.h"
...
using _Cliff__ros_msg_type = create_msgs__msg__Cliff;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Cliff__ros_msg_type * ros_message = static_cast<const _Cliff__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Cliff__ros_msg_type * ros_message = static_cast<_Cliff__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _Cliff__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_create_msgs__msg__Cliff(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = create_msgs__msg__Cliff;
    is_plain =
      (
...
static size_t _Cliff__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_create_msgs__msg__Cliff(
...
static message_type_support_callbacks_t __callbacks_Cliff = {
  "create_msgs::msg",
  "Cliff",
...
static rosidl_message_type_support_t _Cliff__type_support = {
