...
#include "create_msgs/msg/detail/charging_state__rosidl_typesupport_fastrtps_c.h"
...
using _ChargingState__ros_msg_type = create_msgs__msg__ChargingState;
  ...
  void * untyped_ros_message)
{
  ...
  _ChargingState__ros_msg_type * ros_message = static_cast<_ChargingState__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_create_msgs__msg__ChargingState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ChargingState__ros_msg_type * ros_message = static_cast<const _ChargingState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ChargingState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_create_msgs__msg__ChargingState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_create_msgs
size_t max_serialized_size_create_msgs__msg__ChargingState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = create_msgs__msg__ChargingState;
    is_plain =
      (
...
static size_t _ChargingState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_create_msgs__msg__ChargingState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, create_msgs, msg, ChargingState)() {
