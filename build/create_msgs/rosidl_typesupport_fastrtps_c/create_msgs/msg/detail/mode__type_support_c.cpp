...
#include "create_msgs/msg/detail/mode__rosidl_typesupport_fastrtps_c.h"
...
using _Mode__ros_msg_type = create_msgs__msg__Mode;
...
static uint32_t _Mode__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_create_msgs__msg__Mode(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = create_msgs__msg__Mode;
    is_plain =
      (
...
static size_t _Mode__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_create_msgs__msg__Mode(
