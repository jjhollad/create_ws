...
static const _Mode_type_support_symbol_names_t _Mode_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, create_msgs, msg, Mode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, create_msgs, msg, Mode)),
  }
};
...
{
  return &::create_msgs::msg::rosidl_typesupport_cpp::Mode_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, create_msgs, msg, Mode)() {
  return get_message_type_support_handle<create_msgs::msg::Mode>();
}
