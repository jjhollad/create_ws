...
#include "create_msgs/msg/detail/bumper__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = create_msgs::msg::Bumper;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const create_msgs::msg::Bumper *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<create_msgs::msg::Bumper *>(
    untyped_ros_message);
...
{
  return &create_msgs::msg::typesupport_fastrtps_cpp::_Bumper__handle;
}
