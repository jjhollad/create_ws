...
#include "create_msgs/msg/detail/mode__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = create_msgs::msg::Mode;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const create_msgs::msg::Mode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<create_msgs::msg::Mode *>(
    untyped_ros_message);
...
static size_t _Mode__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Mode(full_bounded, is_plain, 0);
...
{
  return &create_msgs::msg::typesupport_fastrtps_cpp::_Mode__handle;
}
